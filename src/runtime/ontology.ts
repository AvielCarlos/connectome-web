...
export const APP_MANIFEST: AppManifestEntry[] = [
  ...
  },
  {
    ...
    description: 'The IOO neural graph: nodes, paths, constraints, prerequisites, screen patterns, actions, and outcomes.',
    purpose: 'The core intelligence build: route people from current state to desired reality through digital and physical steps.',
  },
  {
    id: 'profile',
    name: 'Profile',
