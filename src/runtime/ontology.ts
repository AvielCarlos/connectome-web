...
export const APP_MANIFEST: AppManifestEntry[] = [
  ...
  },
  {
    ...
    description: 'iDo / Path Feed: a TikTok-style life-path surface for building and progressing toward desired states and experiences.',
    purpose: 'Renders concrete next choices and micro-nodes; the feed itself learns as a neural graph of pathway progression.',
  },
  {
    id: 'ivive',
    name: 'iVive',
  ...
  },
  {
    ...
    description: 'Ontology domain inside the IOO neural graph: contribution, work, service, products, community, reward, and civic life.',
    purpose: 'Not a standalone app for now. Used as graph metadata for opportunities, missions, contribution, and reward pathways.',
  },
  {
    id: 'aventi',
    name: 'Aventi',
    ...
    description: 'Ontology domain inside the IOO neural graph: adventures, events, dating, friendships, spontaneity, and aliveness.',
    purpose: 'Not a standalone app for now. Used as graph metadata for experiences and physical-world pathway nodes.',
  },
  {
    id: 'goals',
    name: 'Goals',
    ...
    description: 'Path feature: living quests across iVive, Aventi, and Eviva, producing shared datapoints for Aura.',
    purpose: 'Turns desires into structured goals with constraints, options, micro-nodes, and real-world steps.',
  },
  {
    id: 'routines',
    name: 'Routines',
  ...
  },
  {
    ...
    description: 'Internal/Ascension Technologies services and tools, separate from the consumer Aura/iDo path.',
    purpose: 'Keeps founder/operator offerings out of the ordinary Aura consumer journey.',
  },
  {
    id: 'ioo',
    name: 'Path Map',
