/**
 * OraCard — renders any ScreenSpec component type in the browser
 */
import React, { useState } from 'react';
import { ScreenComponent } from '../lib/OraClient';
...
export function OraCard({ component: comp, index, onAction }: OraCardProps) {
